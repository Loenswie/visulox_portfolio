...
useHead(() => ({
  title: 'Work | VISULOX',
  description: 'Selected branding, graphic design and campaign work by VISULOX / Louis Lefebure, grafisch ontwerper based in West-Vlaanderen, with web design and development to bring it to life.'
}))
